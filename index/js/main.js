$('.shelf.a').mousedown(function(){
	...
	$('.title.b').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
	$('.title.c').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
	$('.title.d').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
	$('.title.e').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
	$('.title.f').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
})

$('.shelf.b').mousedown(function(){
	$('.case').css({'grid-template-columns':'4rem 1fr 50% 1fr 1fr 1fr 1fr 4rem'})
	$('.title.a').css({'font-family':'Dignitas','font-size':'1rem','line-height':'100%','text-transform':'capitalize'})
