(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[115],{"7LJr":function(e,t,a){"use strict"
var i=a("ouhR")
var n=a.n(i)
...
a.push(u)
t.data("loading_images",a)
if(t.css("position")&&"static"!=t.css("position")){u.css({zIndex:l,position:"absolute",top:s,left:r})
...
const u=s.data("media_comment_id")||d.a.trim(s.find(".media_comment_id:first").text())||(i=s.attr("id"))&&i.match(/^media_comment_/)&&i.substring(14)||d.a.trim(s.parent().find(".media_comment_id:first").text())
const _=s.data("author")
const h=s.data("created_at")
let p
p=_&&h?o.t("Play media comment by %{name} from %{createdAt}.",{name:_,createdAt:h}):o.t("Play media comment.")
...
const o=s.closest("p")
o.attr("title")||o.attr("title",Object(l["a"])(p))
let m=s
if(a){m=s.clone().empty().removeClass("instructure_file_link")
const e=s.parent(".instructure_file_link_holder")
e.length?m.appendTo(e):s.after(m)}else s.empty()
...
if(i.length>0&&0===i.closest(s).length){"undefined"!=typeof e.data[a]&&null!==e.data[a]||(e.data[a]="")
...
else try{var r=e.data[a].toString()
i.html(Object(o["a"])(r))}catch(e){}}})}e.hrefValues&&e.data&&this.find("a,span[rel]").each(function(){var t,a,i,o=n()(this)
for(var s in e.hrefValues){if(!e.hrefValues.hasOwnProperty(s))continue
var r=e.hrefValues[s]
if(t=o.attr("href")){var l=n.a.replaceTags(t,r,encodeURIComponent(e.data[r]))
var u=o.text()===o.html()?o.text():null
if(t!==l){o.attr("href",l)
u&&o.text(u)}}(a=o.attr("rel"))&&o.attr("rel",n.a.replaceTags(a,r,e.data[r]));(i=o.attr("name"))&&o.attr("name",n.a.replaceTags(i,r,e.data[r]))}})
...
o&&(a[e.dataValues[t]]=o)}if(e.htmlValues)for(t in e.htmlValues){var s=this.find("."+e.htmlValues[t].replace(/\[/g,"\\[").replace(/\]/g,"\\]")+":first")
o=null
...
return(a>1?[t[a-2],t[a-1]]:t).join("")}var g=p(window.location.hostname)
l.a.expr[":"].external=function(e){var t=l()(e).attr("href")
return!!(t&&t.length&&!t.match(/^(mailto\:|javascript\:)/)&&e.hostname&&p(e.hostname)!=g)}
...
e.dialog()})}).end().filter(".draggable").draggable().end().filter(".resizable").resizable().end().filter(".sortable").sortable().end().filter(".tabs").each(function(){l()(this).tabs()}).end().end().find("a:not(.not_external, .external):external").each(function(){var e=Object(c["a"])(s.t("titles.external_link","Links to an external site."))
...
if(l.a.trim(e.text())){var t=l()("<span class='instructure_file_holder link_holder'/>"),a=l()("<a class='file_preview_link' aria-hidden='true' href='"+Object(c["a"])(e.attr("href"))+"' title='"+Object(c["a"])(s.t("titles.preview_document","Preview the document"))+"' style='padding-left: 5px;'><img src='/images/preview.png' alt='"+Object(c["a"])(s.t("titles.preview_document","Preview the document"))+"'/></a>")
...
var t=l()("<img/>")
var a=null
switch(l()(this).data("role")){case"TeacherEnrollment":a=s.t("switched_roles_message.teacher","You have switched roles temporarily for this course, and are now viewing the course as a teacher.  You can restore your role and permissions from the course home page.")
break
case"StudentEnrollment":a=s.t("switched_roles_message.student","You have switched roles temporarily for this course, and are now viewing the course as a student.  You can restore your role and permissions from the course home page.")
break
case"TaEnrollment":a=s.t("switched_roles_message.ta","You have switched roles temporarily for this course, and are now viewing the course as a TA.  You can restore your role and permissions from the course home page.")
break
case"ObserverEnrollment":a=s.t("switched_roles_message.observer","You have switched roles temporarily for this course, and are now viewing the course as an observer.  You can restore your role and permissions from the course home page.")
break
case"DesignerEnrollment":a=s.t("switched_roles_message.designer","You have switched roles temporarily for this course, and are now viewing the course as a designer.  You can restore your role and permissions from the course home page.")
break
default:a=s.t("switched_roles_message.student","You have switched roles temporarily for this course, and are now viewing the course as a student.  You can restore your role and permissions from the course home page.")}t.attr("src","/images/warning.png").attr("title",a).css({paddingRight:2,width:12,height:12})
...
t.html("<h2/><iframe style='background: url(/images/ajax-loader-medium-444.gif) no-repeat left top; width: 800px; height: 350px; border: 0;' src='about:blank' borderstyle='0'/><div style='text-align: right;'><a href='#' class='original_link external external_link' target='_blank'>"+Object(c["a"])(s.t("links.view_equella_content_in_new_window","view the content in a new window"))+"</a>")
...
l()("body").append(t)
t.dialog({autoOpen:false,width:"auto",resizable:false,title:s.t("titles.equella_content_preview","Equella Content Preview"),close:function(){t.find("iframe").attr("src","about:blank")}})}t.find(".original_link").attr("href",l()(this).attr("href"))
...
var o=l()('<a href="#" style="font-size: 0.8em;" class="hide_file_preview_link">'+Object(c["a"])(s.t("links.minimize_file_preview","Minimize File Preview"))+"</a>").click(e=>{e.preventDefault()
t.show()
t.focus()
n.remove()
...
o.user_id==a&&(i=o)}if(i){var s=i.submission_comments[i.submission_comments.length-1].submission_comment
s.post_date=l.a.datetimeString(s.created_at)
s.message=s.formatted_body||s.comment
t.fillTemplateData({data:s,htmlValues:["message"]})}}else{var r=e.discussion_entry
r.post_date=l.a.datetimeString(r.created_at)
t.find(".content > .message_html").val(r.message)
t.fillTemplateData({data:r,htmlValues:["message"]})}t.find(".message").show()
...
l()("button.submit_button").text(s.t("status.posting_message","Posting Message..."))},success:function(e){l()("button").attr("disabled",false)
...
var s={discussion_topic_id:i.id}
...
var m=d
if(i<864e5)if(i<36e5)if(i<6e4)m=s.t("#time.less_than_a_minute_ago","less than a minute ago")
else{var c=parseInt(i/6e4,10)
m=s.t("#time.count_minutes_ago",{one:"1 minute ago",other:"%{count} minutes ago"},{count:c})}else{var _=parseInt(i/36e5,10)
m=s.t("#time.count_hours_ago",{one:"1 hour ago",other:"%{count} hours ago"},{count:_})}t.text(m)
t.attr("title",d)}setTimeout(r,1)}else setTimeout(o,6e4)}setTimeout(o,100)
...
"unpublished"===o.workflow_state&&(o.title+=" ("+s.t("draft","Draft")+")")
o.text="previous"==a?s.t("buttons.previous_module","Previous Module"):s.t("buttons.next_module","Next Module")
...
if(_.length){var p=l()(_[0])
Promise.all([a.e(4),a.e(63),a.e(581)]).then(a.bind(null,"/j35")).then(()=>{p.moduleSequenceFooter({courseID:p.attr("data-course-id"),assetType:p.attr("data-asset-type"),assetID:p.attr("data-asset-id")})})}}l()("#right-side").delegate(".more_link","click",function(e){var t=l()(this)
...
function s(e){t.confirmDelete({url:e,noMessage:true,success:function(){o&&l.a.flashMessage(o)
l()(this).slideUp(function(){l()(this).remove()
i.focus()})}})}s(n)})
setTimeout(function(){l()("#content a:external,#content a.explicit_external_link").not(".external").each(function(){var e=s.t("titles.external_link","Links to an external site.")
...
if(o){let n=0
let s=e
while(n<=o){a=""===i[n]?s.length:i[n]
s=s[a]=n<o?s[a]||(i[n+1]&&isNaN(i[n+1])?{}:[]):t
...
const s=Object(m["a"])(a.canvadoc_session_url)
o=l()("<iframe/>",{src:s,width:a.width,allowfullscreen:"1",css:{border:0,overflow:"auto",height:"99%","min-height":i},id:a.id})
o.appendTo(e)
o.load(()=>{n("canvadocs")
l.a.isFunction(a.ready)&&a.ready()})}else if(!i["a"].disableGooglePreviews&&(!a.mimetype||l.a.isPreviewable(a.mimetype,"google"))&&a.attachment_id||a.public_url){var r=function(){var e="//docs.google.com/viewer?"+l.a.param({embedded:true,url:a.public_url})
...
e.replace(/\+/g," ").split("&").forEach(e=>{let n=e.split("="),s=Object(i["a"])(n,2),r=s[0],l=s[1]
